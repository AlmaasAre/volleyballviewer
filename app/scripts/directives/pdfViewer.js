...
angular.module('volleyballviewerApp')
  .directive('pdfViewer', function () {
    return {
      templateUrl: 'views/directives/pdf-viewer.html',
      restrict: 'E',
      scope:{
          pdfUrl:'@'
      },
      link: function postLink(scope, element, attrs) {
          ...
          var DEFAULT_URL = attrs.pdfUrl;
//var DEFAULT_URL = 'http://www.selab.isti.cnr.it/ws-mate/example.pdf';
